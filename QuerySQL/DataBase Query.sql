...
begin
	...
	begin
		insert into producto(Codigo,Nombre,Descripcion,IdCategoria,Stock,PrecioCompra,PrecioVenta,Estado) values (@Codigo,@Nombre,@Descripcion,@IdCategoria,@Stock,@PrecioCompra,@PrecioVenta,@Estado)
		set @Resultado = SCOPE_IDENTITY()
	end
	ELSE
